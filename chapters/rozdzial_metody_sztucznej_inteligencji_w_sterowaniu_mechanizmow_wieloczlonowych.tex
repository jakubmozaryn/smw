...
%
  ...
  %
  \begin{comment}
  \par £atwo zauwa¿yæ, ¿e przesuniêcie mo¿e byæ interpretowane jako waga sygna³u wejœciowego neuronu $u_{\mathrm{n}0}=1$
  %
  \begin{equation}
  b_{\mathrm{n}}=w_{\mathrm{n}0}u_{\mathrm{n}0}=w_{\mathrm{n}0}
  \end{equation}
  \end{comment}
  %
  ...
  \begin{figure}[htb!]
  	\begin{center}
  		\includegraphics[scale=1]{model_neuronu.eps}
  ...
  \begin{figure}[htb!]
  	\begin{center}
  		\includegraphics[scale=0.9]{funkcje_aktywacji.eps}
  ...
  \begin{figure}[htb!]
  	\begin{center}
  		\includegraphics[scale=1]{model_warstwy_siec_jednowarstwowa.eps}
  ...
  \begin{figure}[htb!]
  	\begin{center}
  		\includegraphics[scale=1]{model_sieci.eps}
  ...
  \begin{figure}[htb!]
  	\begin{center}
  		\includegraphics[scale=1]{model_warstwy.eps}
  ...
  \nabla E(W)=\left \frac{\partial E}{\partial W} \right|_{W=W(i)}=\left \left[\begin{array}{c}
  ...
  H(W_{(i)})=\left \frac{\partial^2 E}{\partial^2 W} \right|_{W=W(i)}=\left \left[\begin{array}{ccc}
  ...
  \begin{enumerate}
  	\item
  	{\emph{Dana jest próbka $s=\{ u, y \}$, liczba sygna³ów wejœciowych do sieci neuronowej $n^{(1)}=n$,
  			liczba warstw sieci $L$, liczba neuronów w warstwach sieci $m^{(i)}, i=1,\ldots,L$, sygna³y wejœciowe do sieci
  			$u^{(1)}_{j}=u_{j}, j=1,\ldots,n$, macierze wag i wektory przesuniêæ sygna³ów wyjœciowych sumatorów warstw sieci $W^{(i)}, b^{(i)}, i=1,\dots,L$, liczba sygna³ów wyjœciowych z sieci $m^{(L)}=m$, sygna³y wyjœciowe z sieci $y_{\mathrm{NN}}=[y_{\mathrm{NN}i}]_{m^{(L)}\times 1}$}}
  	\item
  	\emph{Obliczyæ $x^{(l)}, y^{(l)}$ wg (\ref{4.3.4}) dla $l=1,\ldots, L$.}
  	\item
  	\emph{Przyj¹æ l=L.}
  	\item
  	{
  		\emph{Obliczyæ wartoœæ pochodnej funkcji celu sieci neuronowej wzglêdem sygna³ów wyjœciowych z sieci
  			%
  		...
  		\item{\emph{Wyznaczyæ wartoœæ pochodnej funkcji celu sieci neuronowej wzglêdem sygna³ów $x^{(l)}__{i}$\\
  				Jeœli $l=L$
  				%
  			...
  			\item{
  				\emph{Przyj¹æ $l=l-1$, jeœli $l>0$ przejœæ do punktu} 4, \emph{w przeciwnym przypadku zakoñczyæ algorytm.}
  			}
  		\end{enumerate}
  		%
  		\begin{flushright}
