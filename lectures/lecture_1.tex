...
\frametitle{Zadanie proste geometrii}
    Zadanie proste geometrii (czasem kinematyki) MW - obliczenie wspó³rzêdnych kartezjañskich punktu na MW znaj¹c jego wspó³rzêdne przegubowe (konfiguracyjne, maszynowe). Zazwyczaj chodzi o jeden z punktów ostatniego cz³onu maszyny w uk³adzie bazowym. \\
    %
    \begin{equation}
...
%
\frame{
\frametitle{Zadanie proste geometrii - przyk³ad}
